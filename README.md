> **Final far-depth inference fork**
>
> This repository contains the GitHub-ready version of the InfiniDepth far-depth inference modifications.
> For the final runnable entrypoint, algorithm notes, and upload commands, see [README_FINAL.md](README_FINAL.md).
>
> English terms: `inference` means 推理; `profile` means 运行配置档; `checkpoint` means 模型权重文件.
...
<!-- The original demo GIF is intentionally not included in this GitHub-ready fork because it is a large binary asset. -->
<p><strong>Demo asset omitted in this lightweight GitHub-ready fork.</strong></p>
